...
from .io.nninput import NNInput
from .io.nnoutput import NNOutput
...
class NN(object):
    ...
    @staticmethod
    def getInstance(loadDataFromDefaultFile=False):
    ...
    def trainWithRandomScenario(self):
        ...
        self.setTrainingInput(nnTrainingInputSet)
        self.trainModel()
